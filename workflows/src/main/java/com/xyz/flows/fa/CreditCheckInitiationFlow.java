...
public class CreditCheckInitiationFlow extends FlowLogic<SignedTransaction> {
	...
	public CreditCheckInitiationFlow(UniqueIdentifier loanApplicationId, Party financeAgency) {
	...
	public SignedTransaction call() throws FlowException {
		...
		CreditRatingState outputCreditRatingCheckState = new CreditRatingState(financeNode, creditScoreCheckAgency,
				companyName, businesstype, loanAmount, creditScore, creditScoreDesc, loanVerificationId);

		final Command<CreditRatingCheckContract.Commands.CreditCheckInitiation> creditScoreCheckRequestCommand = new Command<>(
				new CreditRatingCheckContract.Commands.CreditCheckInitiation(),
				Arrays.asList(outputCreditRatingCheckState.getLoaningAgency().getOwningKey(),
						outputCreditRatingCheckState.getCreditAgencyNode().getOwningKey()));

		final TransactionBuilder txBuilder = new TransactionBuilder(notary).addOutputState(outputCreditRatingCheckState)
